...
/**
 * Shows a {@link PreferenceDialogFragmentCompat} asking the user to confirm if they wish to backup
 * their favourites to external storage. If the user confirms, then the backup process is carried
 * out.
 *
 * @author Niall Scott
 */
public class BackupPreferenceDialogFragment extends PreferenceDialogFragmentCompat {
     ...
     */
    public static BackupPreferenceDialogFragment newInstance(@NonNull final String key) {
        final BackupPreferenceDialogFragment f = new BackupPreferenceDialogFragment();
